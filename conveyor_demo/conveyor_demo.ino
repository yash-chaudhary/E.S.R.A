...
const int threshold = 10; // distance is cm
long duration;
int distance;

// motor controller
int in1 = 10; // controls motor spin direction
int in2 = 3;  // controls motor spin direction
int EnA = 11; // connect to PWM pin and to ENA on motor controller to control motor speed via PWM
...
void loop() {
    ...
    if (currentMillis - lastMillis >= interval) {
        ...
        // Print the result
        Serial.print("Change in count: ");
        Serial.println(countDelta);
    ...
    // DC motor control ----------------------------------------------------
    int speed = analogRead(A1); //declaring and reading value from the pin
